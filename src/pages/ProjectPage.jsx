  ...
  return (
    <div className="bg-noise w-full h-[100vh] relative ">
      <div className="bg-[rgba(23,26,48,0.95)] h-full flex items-center flex-col sm:justify-between justify-center">
        <Link to="/" onClick={()=>TapSound()} className="group top-10 sm:left-10 left-5 absolute">
          <svg
            className="fill-white opacity-70 w-8 rotate-180  group-hover:translate-x-[20px] transition-all"
        ...
        <span className="text-3xl text-white font-bold my-12 top-0 ">
          {t("projects.title")}
        </span>
        ...
        <div
          ...
          className="flex flex-row w-full overflow-x-scroll mb-12"
        >
